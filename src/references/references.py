...
def references():
    ...
    CATEGORIES = [
        # 10-K
        "McDonald's Annual Reports (10-K)",
        "McDonald's Annual Reports (10-K)",
        "McDonald's Annual Reports (10-K)",
        "McDonald's Annual Reports (10-K)",
        "McDonald's Annual Reports (10-K)",
        # 10-Q 2014
        "McDonald's Quarterly Data (10-Q)",
        "McDonald's Quarterly Data (10-Q)",
        "McDonald's Quarterly Data (10-Q)",
        # 10-Q 2015
        "McDonald's Quarterly Data (10-Q)",
        ...
        "McDonald's Quarterly Data (10-Q)",
        # Others
        "Consumer Price Index (CPI) by BLS",
        "Market Capital (2014-2018)",
        "Global Fast Food Market Size",
        "Assumed Growth: 2003 SARS",
        "Assumed Growth: 2008 Crisis",
    ]
    YEARS_SOURCES = [
        # 10-K
        "2014",
        ...
        "2018 (Q3)",
        # Others
        "BLS CPI-U Historical",
        "Stock Analysis",
        "IBISWorld Global Fast Food",
        "Australian Treasury Economic Roundup",
    ...
    df_refs = pd.DataFrame({"Category": CATEGORIES, "Year/Source": YEARS_SOURCES, "Used in": USED_IN})
