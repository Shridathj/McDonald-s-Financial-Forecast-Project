...
def data_source():
    ...
    styled_df = df.style.set_table_styles(
        [
            {
                "selector": 'th.col_heading[col="Year"]',
                "props": [("background-color", "#e6f3ff"), ("color", "navy"), ("font-weight", "bold")],
            },
            {
                "selector": 'th.col_heading[col="Nominal: Global Fast-food market size"], th.col_heading[col="Nominal: Revenues"]',
                "props": [("background-color", "#f0f8ff"), ("color", "black"), ("font-weight", "bold")],
            },
            {
                "selector": 'th.col_heading[col="Baseline: Global Fast-food market size"], th.col_heading[col="Pandemic: Global Fast-food market size"], th.col_heading[col="Hindsight: Global Fast-food market size"]',
                "props": [("background-color", "#f5f5f5"), ("color", "gray"), ("font-weight", "bold")],
            },
            {
                "selector": 'th.col_heading[col="Baseline: Revenues"], th.col_heading[col="Pandemic: Revenues"], th.col_heading[col="Hindsight: Revenues"]',
    ...
    df_cpi = pd.DataFrame({"Year": cpi_years, "CPI": cpi_values, "Multiplier": multiplier_values})
