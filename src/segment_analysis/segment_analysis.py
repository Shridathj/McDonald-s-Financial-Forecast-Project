...
def segment_analysis():
    ...
    # CPI Multipliers
    multipliers = {"2014": 1.061, "2015": 1.059, "2016": 1.046, "2017": 1.024, "2018": 1.000}
    ...
    def style_table(df, title, adjustment=""):
        ...
        styled = df.style.format(
            {
                "2014": format_currency,
                "2015": format_currency,
                "2016": format_currency,
                "2017": format_currency,
                "2018": format_currency,
            }
        )
        ...
        styled = (
            styled.set_properties(
                **{
                ...
                subset=pd.IndexSlice[:, ["Section", "Segment"]],
            )
            .set_properties(
                **{
                    "text-align": "right",
                ...
                subset=pd.IndexSlice[:, ["2014", "2015", "2016", "2017", "2018"]],
            )
            .set_table_styles(
                [
                    {
    ...
    def plot_revenues():
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[9178.7, 9063.9, 8632.3, 8198.6, 7665.8],
                mode="lines+markers",
                name="U.S",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[9065.7, 8064.2, 7555.7, 7516.5, 7600.1],
                mode="lines+markers",
                name="International Lead Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[7263.0, 6537.0, 6444.1, 5666.0, 3988.7],
                mode="lines+markers",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[3608.0, 3247.3, 3122.4, 1987.1, 1770.6],
                mode="lines+markers",
                name="Foundational Markets & Corporate",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[29115.2, 26912.4, 25754.5, 23368.1, 21025.2],
                mode="lines+markers",
                name="Total Revenues",
        ...
        fig.update_layout(
            title="Revenues by Segment (All Segments + Total)",
            xaxis_title="Year",
            yaxis_title="Value ($M)",
    ...
    def plot_operating_income():
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[3737.4, 3825.1, 3942.1, 4118.9, 4015.6],
                mode="lines+markers",
                name="U.S",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[3219.6, 2872.6, 2969.0, 3242.5, 3485.7],
                mode="lines+markers",
                name="International Lead Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[990.9, 890.7, 1097.0, 2049.4, 1001.2],
                mode="lines+markers",
                name="High Growth Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[8434.1, 7567.1, 8100.7, 9782.0, 8822.6],
                mode="lines+markers",
        ...
        fig.update_layout(
            title="Operating Income by Segment (All Segments + Total)",
            xaxis_title="Year",
            yaxis_title="Value ($M)",
            template="plotly_white",
            height=400,
    ...
    def plot_assets():
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[12596.3, 12502.7, 12510.8, 12952.2, 14483.8],
                mode="lines+markers",
                name="U.S",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[13303.2, 11793.3, 9531.7, 12128.6, 12713.0],
                mode="lines+markers",
                name="International Lead Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[6223.8, 5558.3, 5448.2, 4588.2, 4404.9],
                mode="lines+markers",
                name="High Growth Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[4191.9, 10322.8, 4960.3, 4946.0, 1209.5],
                mode="lines+markers",
                name="Foundational Markets & Corporate",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[36315.3, 40177.1, 32451.0, 34615.0, 32811.2],
                mode="lines+markers",
                name="Total Assets",
                line=dict(width=2, color=total_color),
                marker=dict(size=6, color=total_color),
        ...
        fig.update_layout(
            title="Assets by Segment (All Segments + Total)",
            xaxis_title="Year",
            yaxis_title="Value ($M)",
            template="plotly_white",
            height=400,
    ...
    def plot_capital_expenditure():
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[781.0, 564.7, 613.7, 881.9, 1849.8],
                mode="lines+markers",
                name="U.S",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[840.4, 631.3, 664.8, 527.7, 436.4],
                mode="lines+markers",
                name="International Lead Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[853.9, 572.4, 515.9, 387.6, 285.6],
                mode="lines+markers",
                name="High Growth Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[259.4, 144.1, 105.6, 98.7, 169.9],
                mode="lines+markers",
                name="Foundational Markets & Corporate",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[2734.7, 1912.4, 1900.0, 1895.8, 2741.7],
                mode="lines+markers",
                name="Total Capital and Expenditure",
                line=dict(width=2, color=total_color),
                marker=dict(size=6, color=total_color),
        ...
        fig.update_layout(
            title="Capital and Expenditure by Segment (All Segments + Total)",
            xaxis_title="Year",
            yaxis_title="Value ($M)",
            template="plotly_white",
            height=400,
    ...
    def plot_capex():
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[543.6, 546.0, 533.7, 537.4, 598.4],
                mode="lines+markers",
                name="U.S",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[552.8, 488.4, 472.4, 472.5, 472.9],
                mode="lines+markers",
                name="International Lead Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[411.7, 385.6, 378.7, 237.3, 233.0],
                mode="lines+markers",
                name="High Growth Markets",
        ...
        fig.add_trace(
            go.Scatter(
                x=years,
                y=[237.0, 228.4, 201.6, 150.1, 177.7],
                mode="lines+markers",
                name="Foundational Markets & Corporate",
        ...
        fig.update_layout(
            title="CapEx by Segment (All Segments)",
            xaxis_title="Year",
            yaxis_title="Value ($M)",
            template="plotly_white",
            height=400,
