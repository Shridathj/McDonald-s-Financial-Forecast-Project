...
- The model does not explicitly incorporate post-2020 structural changes at McDonald’s, including the rapid expansion of delivery partnerships (Uber Eats, DoorDash, etc.), digital ordering platforms. These factors contributed to stronger real-world recovery than projected in the disruption scenarios.
...
- This analysis focuses exclusively on McDonald’s Corporation. Results and resilience insights may not be directly transferable to other quick-service restaurant operators.
...
- The Kaggle notebook version (https://www.kaggle.com/code/prnavjoshi/mcdonald-s-financial-forecast-project) provides an alternative interactive environment.
